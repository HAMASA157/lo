    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "◌sᴏᴜʀᴄᴇ ᴍɪʀᴀ◌", url=f"t.me/UI_IUSIA"),
                    InlineKeyboardButton(
                        "◌ᴅᴇᴠᴇʟᴏᴘᴇʀ◌", url=f"t.me/Y_F_G5")
                ],[
                    InlineKeyboardButton(
                        "", callback_data="close"),
                    InlineKeyboardButton(
...
async def spo(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "◌ هلا فيك في قسم تشغيل اغاني Spotify ♪\n\n• تقدر تشغيل الاغاني عن طريق الرد على الرابط او وضعه مع الامر .\n\n• مثال : [ `سيا شغلي https://open.spotify.com/track/2GQB3Xe1J9D2sK90AtHfhI?si=aIuly9l-T-Gy5GvfZxpUiw&context=spotify%3Aplaylist%3A37i9dQZF1DXcJUwMZo8Ss1i=1616715870&l=ar` ]\n\n**تابع الفيديو للتوضيح اكثير .**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
