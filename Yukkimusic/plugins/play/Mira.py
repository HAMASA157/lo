...
ᴄʜᴀɴɴᴇʟ -› [𝙎𝙨𝙞𝘼𝙖 𝙈𝘂𝙎𝗶𝘾](t.me/UI_IUSIA)""", 
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "تحديثات سيا 🍻", url=f"t.me/UI_IUSIA")
                    ]
                ]
            ),
...
@app.on_message(filters.command("سيا نادي المطور", [".", ""]) & filters.group)
async def kstr(client: Client, message: Message):
       ...
       await message.reply_text(
        f"""- **ابشر ياعيوني ارسلت للمطور بيخش القروب ويشوف مشكلتك بأقرب وقت\n\n- تابع قناة البوت عشات تشوف التحديثات** -› [• Source Mira •](t.me/UI_IUSIA)""", disable_web_page_preview=True     
    )
...
@app.on_message(filters.regex("^سيا$"))
...
async def down(client, message):
          m = await message.reply("**- ابشر تم اخفاء الازرار بنجاح\n- لو تبي تطلعها مرة ثانية اكتب سيا**", reply_markup= ReplyKeyboardRemove(selective=True))


@app.on_message(filters.group & command("كيفية استخدام سيا"))
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""- **هلا والله ياعيني عشان تفعل بوت سيا اتبع الخطوات الي بالاسفل**
1 • ارفعه مشرف بكل الصلاحيات 
2 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب سيا شغلي + اسم المقطع الصوتي
• مثال : سيا شغلي واتنسيت
- لو واجهت مشكله كلم مطور البوت ~ Y_F_G5""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "• ضيفني لجـروبـك 🎻", url=f"https://t.me/UUTRBOT?startgroup=true"),
                ],
            ]
        ),
        disable_web_page_preview=True
...
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""**- اهلين فيك بسورس سيا ياحلو
...
قناة السورس -› [𝙎𝙨𝙞𝘼𝙖 𝙈𝘂𝙎𝗶𝘾](t.me/UI_IUSIA)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "تحديثات سيا 🍻", url=f"https://t.me/UI_IUSIA"),
                ],[
                    InlineKeyboardButton(
                        "• ضيفني لجـروبـك 🎻", url=f"https://t.me/UUTRBOT?startgroup=true"),
                ],
...
REPLY_MESSAGEE = "- هلا فيك في قسم اوامر سيا"
...
@app.on_message(filters.group & command("اوامر سيا"))
...
• AppleMusic
• Spotify
- لو واجهت مشكلة تواصل مع مطور السورس Y_F_G5**
- [𝙎𝙨𝙞𝘼𝙖 𝙈𝘂𝙎𝗶𝘾](t.me/UI_IUSIA)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
